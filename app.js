...
var app = express();
/* mongoose.connect("mongodb://localhost/thotsApp", {
    useNewUrlParser: true,
    useUnifiedTopology: true
}); */
mongoose.connect("mongodb+srv://chnspart:maxchayan17@yourthot.w6eph.mongodb.net/yourthot?retryWrites=true&w=majority", {
    useNewUrlParser: true,
    useUnifiedTopology: true
});
